...
const char OUTPUT_FILE_TEST[] = "test_text.txt";
const char INPUT_FILE_TEST[] = "test_out.txt";
...
///This function return size of file in bytes
///@param [in] nameFile name of the, which size calculated
...
///This function uses Compare() to compare two arrays of chars
///When comparing, whitespaces will be ignored.
...
///This function uses Compare() to compare two arrays of chars and return
///value > 0, if first array bigger second char by char, return value = 0,
///if arrays are equal, return value < 0 if first array less than second char by char.
///When comparing, whitespaces will be ignored.
...
int FillArrayOfStringsTest (){
    ...
    char *strToCheck = "aaaaaaa\0bbbbbbb\0ccccccccc";
    size_t num = 3;
    char **text = (char**) calloc (num, sizeof(**text));

    int res = FillArrayOfStrings (text, strToCheck, num);
    bool condition = (strcmp (text[0], "aaaaaaa") == 0 && strcmp (text[1], "bbbbbbb") == 0 && strcmp (text[2], "ccccccccc") == 0);
